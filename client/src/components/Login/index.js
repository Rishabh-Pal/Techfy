    ...
    return(
        ...
        <form action="">
         <div className="mt-3">
          ...
          <hr className="mb-3" />
          <button type="submit"  class="border-2 border-indigo-700 bg-indigo-700 text-white py-1 w-full rounded-md hover:bg-transparent hover:text-indigo-700 font-semibold"><i class="fa-solid fa-unlock"></i>  Forget Password</button>
        </form>
